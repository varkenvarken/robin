...
newton_raphson_inverse:
        ...
        mover   sp,sp,2             
        load    r2,r2,0             
        bra     return_0001_052ae4c44972
return_0001_052ae4c44972:
        pop     r10                 
        pop     r9                  
...
inverse:
        ...
        test    r2                  
        beq     end_ifstmt_0009_052ae4c44972
        mover   r4,0,-1             ; load value (id node)
        loadl   r2,frame,r4         ; load value of auto variable for union
        push    r2                  ; binop(&)
        ...
        alu     r2,r3,r2            
        bra     return_0002_052ae4c44972
end_ifstmt_0009_052ae4c44972:
